        ...
        <div className="text-center space-y-6">
          ...
          <div className="space-y-2">
            <p className="text-text-secondary">
              Welcome to Gulu! Your account is now fully activated and you can
              access all features.
            </p>
          </div>
      ...
      >
        <div className="text-center space-y-4">
          ...
          <div className="space-y-2">
            ...
            {email && <p className="font-medium text-text-primary">{email}</p>}
          </div>
    ...
    return (
      ...
      >
        <div className="text-center space-y-4">
          ...
          <div className="space-y-2">
            <p className="text-text-secondary">
              Verification links expire for security reasons. We can send you a
              new one.
            </p>
          </div>
