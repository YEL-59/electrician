    ...
    return (
        ...
        <div>
            ...
            <div className="relative overflow-hidden ">
                <img
                    src="https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80" // Placeholder for building image
                    alt="Falcon Electronics Building"
                    className="w-full h-64 md:h-80 object-cover"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent" />
                {/* <div className="absolute bottom-4 left-4 md:left-8 text-white">
                    <h1 className="text-2xl md:text-4xl font-bold mb-1">Falcon Electronics</h1>
                    <div className="flex items-center space-x-2 text-sm md:text-base">
                        <span className="bg-yellow-400/20 text-yellow-400 px-2 py-1 rounded-full">Organization</span>
                        <span>Status 2023</span>
                    </div>
                </div> */}
            </div>
                            ...
                            <div className="mb-4">
                                ...
                                <div className="flex">
                                    {[1, 2, 3, 4, 5].map((star) => (
                                        <Star
                                            key={star}
                                            className={`h-6 w-6 cursor-pointer ${star <= (hoveredRating || rating) ? 'text-yellow-400 fill-yellow-400' : 'text-gray-300'
                                                }`}
