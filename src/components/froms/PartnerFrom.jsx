        ...
        <div className="min-h-screen p-8">
            <div className="max-w-2xl mx-auto">
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-bold text-gray-900 mb-2">Be a Partner</h1>
                    <p className="text-gray-600 text-lg">Join our partner program</p>
                </div>
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="space-y-2">
                                                ...
                                                <FormControl>
                                                    <Input className="h-10 border border-gray-300 rounded-md px-3 py-2 focus:border-pink-500" placeholder="Company Name" {...field} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="space-y-2">
                                                ...
                                                <FormControl>
                                                    <Input className="h-10 border border-gray-300 rounded-md px-3 py-2 focus:border-pink-500" placeholder="+91-1234567" {...field} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
